...
assert_file "${RESOURCES_ROOT}/desktop-host/setup-assets/macos/setup-node-global-prefix.sh" 'bundled macOS npm prefix helper'
assert_file "${RESOURCES_ROOT}/desktop-host/setup-assets/macos/install-node-cli-tools.sh" 'bundled macOS node CLI pack helper'
assert_file "${RESOURCES_ROOT}/desktop-host/setup-assets/macos/install-claude-code.sh" 'bundled macOS Claude Code installer helper'
assert_file "${RESOURCES_ROOT}/desktop-host/setup-assets/macos/install-cursor-agent.sh" 'bundled macOS Cursor Agent installer helper'
assert_file "${RESOURCES_ROOT}/desktop-host/setup-assets/macos/install-goose.sh" 'bundled macOS Goose installer helper'
assert_file "${RESOURCES_ROOT}/desktop-host/setup-assets/macos/install-junie.sh" 'bundled macOS Junie installer helper'
assert_file "${RESOURCES_ROOT}/desktop-host/setup-assets/macos/install-kiro-cli.sh" 'bundled macOS Kiro installer helper'
assert_file "${RESOURCES_ROOT}/desktop-host/setup-assets/macos/check-installation.sh" 'bundled macOS readiness audit helper'
