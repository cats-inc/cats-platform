...
function createUnixSetupAssets(platform: UnixAssetPlatform): DesktopSetupAsset[] {
  ...
  return [
    ...
    {
      id: `${platform}-antigravity-native-installer-script`,
      helperId: `${platform}-antigravity-native-installer`,
      label: `${platformLabel} Antigravity CLI installer`,
      kind: 'provider_installer',
      pack: 'native_cli_pack',
      platform,
      sourceRelativePath: `${sourceRoot}/install-antigravity.sh`,
      stageRelativePath: `${stageRoot}/install-antigravity.sh`,
      packagedRelativePath: `${packagedRoot}/install-antigravity.sh`,
      targetPlatforms: [platform],
      supportsCheckOnly: true,
      supportsApply: true,
      supportsUpgrade: true,
      ...
      resumable: true,
      notes: [
        `Installs or upgrades Antigravity CLI as a user-scoped native binary on packaged ${platformLabel} hosts.`,
      ],
    },
    {
      id: `${platform}-muse-native-installer-script`,
      helperId: `${platform}-muse-native-installer`,
      label: `${platformLabel} Meta Muse CLI installer`,
      kind: 'provider_installer' as const,
      pack: 'native_cli_pack' as const,
      platform,
      sourceRelativePath: `${sourceRoot}/install-meta-cli.sh`,
      stageRelativePath: `${stageRoot}/install-meta-cli.sh`,
      packagedRelativePath: `${packagedRoot}/install-meta-cli.sh`,
      targetPlatforms: [platform],
      supportsCheckOnly: true,
      supportsApply: true,
      supportsUpgrade: true,
      ...
      resumable: true,
      notes: [
        `Installs or upgrades Meta Muse CLI as a user-scoped launcher under ~/.local/bin on packaged ${platformLabel} hosts.`,
        'Version comes from the .muse-version file the launcher maintains; the helper never executes muse, because the launcher forwards every argument to the agent binary.',
      ],
    },
    {
      id: `${platform}-devin-native-installer-script`,
      helperId: `${platform}-devin-native-installer`,
      label: `${platformLabel} Devin CLI installer`,
      kind: 'provider_installer' as const,
      pack: 'native_cli_pack' as const,
      platform,
      sourceRelativePath: `${sourceRoot}/install-devin.sh`,
      stageRelativePath: `${stageRoot}/install-devin.sh`,
      packagedRelativePath: `${packagedRoot}/install-devin.sh`,
      targetPlatforms: [platform],
      supportsCheckOnly: true,
      supportsApply: true,
      supportsUpgrade: true,
      ...
      resumable: true,
      notes: [
        `Installs or upgrades Devin CLI on packaged ${platformLabel} hosts, stripping the installer's interactive setup wizard.`,
      ],
    },
    {
      id: `${platform}-grok-native-installer-script`,
      helperId: `${platform}-grok-native-installer`,
      label: `${platformLabel} Grok CLI installer`,
      kind: 'provider_installer',
      pack: 'native_cli_pack',
      platform,
      sourceRelativePath: `${sourceRoot}/install-grok.sh`,
      stageRelativePath: `${stageRoot}/install-grok.sh`,
      packagedRelativePath: `${packagedRoot}/install-grok.sh`,
      targetPlatforms: [platform],
      supportsCheckOnly: true,
      supportsApply: true,
      supportsUpgrade: true,
      ...
      resumable: true,
      notes: [
        `Installs or upgrades Grok CLI as a user-scoped native binary under ~/.grok/bin on packaged ${platformLabel} hosts.`,
      ],
    },
    {
...
export const DESKTOP_SETUP_ASSETS: DesktopSetupAsset[] = [
  ...
  {
    id: 'windows-vcredist-installer-script',
    helperId: 'windows-vcredist-installer',
    label: 'Windows Microsoft Visual C++ 2015-2022 Redistributable (x64)',
    kind: 'prerequisite_helper',
    pack: 'native_cli_pack',
    platform: 'windows',
    sourceRelativePath: 'scripts/windows/Install-VcRedist.ps1',
    stageRelativePath: 'shared/setup-assets/windows/Install-VcRedist.ps1',
    packagedRelativePath: 'desktop/setup-assets/windows/Install-VcRedist.ps1',
    targetPlatforms: ['windows'],
    supportsCheckOnly: true,
    supportsApply: true,
    supportsUpgrade: true,
    ...
    resumable: true,
    notes: [
      'Installs or upgrades the Microsoft Visual C++ 2015-2022 Redistributable (x64) so Rust-based CLIs (codex, native Claude/Cursor/Kiro/Goose backends) find vcruntime140_1.dll. Without it those binaries exit silently with 0xC0000135 (STATUS_DLL_NOT_FOUND) and the shell appears to do nothing.',
      'Self-elevates through UAC for the actual install; -CheckOnly stays user-scoped for the Settings>Runtime probe.',
      'Uninstall is intentionally omitted: removing the redist would break every Rust-based CLI on the host.',
    ],
  },
  {
  ...
  {
    id: 'windows-antigravity-native-installer-script',
    helperId: 'windows-antigravity-native-installer',
    label: 'Windows Antigravity CLI installer',
    kind: 'provider_installer',
    pack: 'native_cli_pack',
    platform: 'windows',
    sourceRelativePath: 'scripts/windows/Install-Antigravity.ps1',
    stageRelativePath: 'shared/setup-assets/windows/Install-Antigravity.ps1',
    packagedRelativePath: 'desktop/setup-assets/windows/Install-Antigravity.ps1',
    targetPlatforms: ['windows'],
    supportsCheckOnly: true,
    supportsApply: true,
    supportsUpgrade: true,
    ...
    resumable: true,
    notes: [
      'Installs or upgrades Antigravity CLI as a user-scoped native binary on packaged Windows hosts.',
    ],
  },
  {
    id: 'windows-muse-native-installer-script',
    helperId: 'windows-muse-native-installer',
    label: 'Windows Meta Muse CLI installer',
    kind: 'provider_installer',
    pack: 'native_cli_pack',
    platform: 'windows',
    sourceRelativePath: 'scripts/windows/Install-MetaCli.ps1',
    stageRelativePath: 'shared/setup-assets/windows/Install-MetaCli.ps1',
    packagedRelativePath: 'desktop/setup-assets/windows/Install-MetaCli.ps1',
    targetPlatforms: ['windows'],
    supportsCheckOnly: true,
    supportsApply: true,
    supportsUpgrade: true,
    ...
    resumable: true,
    notes: [
      'Installs or upgrades Meta Muse CLI on packaged Windows hosts; the official installer writes muse.cmd plus a PowerShell launcher into %LOCALAPPDATA%/Programs/muse.',
      'Version comes from the .muse-version file the launcher maintains; the helper never executes muse, because the launcher forwards every argument to the agent binary.',
    ],
  },
  {
    id: 'windows-devin-native-installer-script',
    helperId: 'windows-devin-native-installer',
    label: 'Windows Devin CLI installer',
    kind: 'provider_installer',
    pack: 'native_cli_pack',
    platform: 'windows',
    sourceRelativePath: 'scripts/windows/Install-Devin.ps1',
    stageRelativePath: 'shared/setup-assets/windows/Install-Devin.ps1',
    packagedRelativePath: 'desktop/setup-assets/windows/Install-Devin.ps1',
    targetPlatforms: ['windows'],
    supportsCheckOnly: true,
    supportsApply: true,
    supportsUpgrade: true,
    ...
    resumable: true,
    notes: [
      "Installs or upgrades Devin CLI on packaged Windows hosts, stripping the installer's interactive setup wizard.",
    ],
  },
  {
    id: 'windows-grok-native-installer-script',
    helperId: 'windows-grok-native-installer',
    label: 'Windows Grok CLI installer',
    kind: 'provider_installer',
    pack: 'native_cli_pack',
    platform: 'windows',
    sourceRelativePath: 'scripts/windows/Install-Grok.ps1',
    stageRelativePath: 'shared/setup-assets/windows/Install-Grok.ps1',
    packagedRelativePath: 'desktop/setup-assets/windows/Install-Grok.ps1',
    targetPlatforms: ['windows'],
    supportsCheckOnly: true,
    supportsApply: true,
    supportsUpgrade: true,
    ...
    resumable: true,
    notes: [
      'Installs or upgrades Grok CLI as a user-scoped native binary on packaged Windows hosts.',
    ],
  },
  {
...
export const DESKTOP_SETUP_SUPPORT_ASSETS: DesktopSetupSupportAsset[] = [
  ...
  },
  {
    ...
    targetPlatforms: ['windows'],
    notes: [
      'Shared PowerShell helper that runs the per-CLI npm-global install/upgrade/uninstall flow for Codex / Copilot / OpenCode / Kilo / Auggie / Pi.',
    ],
  },
