...
function createUnixSetupAssets(platform: UnixAssetPlatform): DesktopSetupAsset[] {
  ...
  return [
    ...
    {
      id: `${platform}-aider-native-installer-script`,
      helperId: `${platform}-aider-native-installer`,
      label: `${platformLabel} Aider installer`,
      kind: 'provider_installer' as const,
      pack: 'native_cli_pack' as const,
      platform,
      sourceRelativePath: `${sourceRoot}/install-aider.sh`,
      stageRelativePath: `${stageRoot}/install-aider.sh`,
      packagedRelativePath: `${packagedRoot}/install-aider.sh`,
      targetPlatforms: [platform],
      supportsCheckOnly: true,
      supportsApply: true,
      supportsUpgrade: true,
      ...
      resumable: true,
      notes: [
        `Installs or upgrades Aider on packaged ${platformLabel} hosts; uninstall goes through uv because the entry point is a uv tool shim.`,
      ],
    },
    {
...
export const DESKTOP_SETUP_ASSETS: DesktopSetupAsset[] = [
  ...
  {
    id: 'windows-aider-native-installer-script',
    helperId: 'windows-aider-native-installer',
    label: 'Windows Aider installer',
    kind: 'provider_installer',
    pack: 'native_cli_pack',
    platform: 'windows',
    sourceRelativePath: 'scripts/windows/Install-Aider.ps1',
    stageRelativePath: 'shared/setup-assets/windows/Install-Aider.ps1',
    packagedRelativePath: 'desktop/setup-assets/windows/Install-Aider.ps1',
    targetPlatforms: ['windows'],
    supportsCheckOnly: true,
    supportsApply: true,
    supportsUpgrade: true,
    ...
    resumable: true,
    notes: [
      'Installs or upgrades Aider on packaged Windows hosts; uninstall goes through uv because the entry point is a uv tool shim.',
    ],
  },
  {
