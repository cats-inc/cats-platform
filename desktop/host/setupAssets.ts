...
function createUnixSetupAssets(platform: UnixAssetPlatform): DesktopSetupAsset[] {
  ...
  const packagedRoot = `desktop-host/setup-assets/${platform}`;
...
export const DESKTOP_SETUP_SUPPORT_ASSETS: DesktopSetupSupportAsset[] = [
  {
    ...
    packagedRelativePath: 'desktop-host/setup-assets/windows/_HiddenProcess.ps1',
    targetPlatforms: ['windows'],
    notes: [
  ...
  },
  {
    ...
    packagedRelativePath: 'desktop-host/setup-assets/shared/unix-provider-cli-common.sh',
  ...
  },
  {
    ...
    packagedRelativePath: 'desktop-host/setup-assets/shared/unix-node-cli-common.sh',
    targetPlatforms: ['linux', 'macos'],
    notes: [
