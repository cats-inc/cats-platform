...
const LOCAL_PROVIDER_BASELINES: DesktopLocalProviderBaseline[] = [
  ...
  },
  {
    ...
    currentHome: 'cats-platform/scripts/{windows,linux,macos}/Install-Codex.{ps1,sh}',
    targetHome: 'cats-platform packaged-host provider assets',
    notes: [
  ...
  },
  {
    ...
    pack: 'native_cli_pack',
    helperIds: [
      'windows-copilot-native-installer',
      'linux-copilot-native-installer',
      'macos-copilot-native-installer',
    ],
    currentHome: 'cats-platform/scripts/{windows,linux,macos}/Install-Copilot.{ps1,sh}',
    targetHome: 'cats-platform packaged-host provider assets',
    notes: [
      'Bundled through the repo-owned per-CLI npm-global helper on each supported host platform.',
    ],
  },
  {
    ...
    pack: 'native_cli_pack',
    helperIds: [
      'windows-opencode-native-installer',
      'linux-opencode-native-installer',
      'macos-opencode-native-installer',
    ],
    currentHome: 'cats-platform/scripts/{windows,linux,macos}/Install-OpenCode.{ps1,sh}',
    targetHome: 'cats-platform packaged-host provider assets',
    notes: [
      'Bundled through the repo-owned per-CLI npm-global helper on each supported host platform.',
    ],
  },
  {
    ...
    pack: 'native_cli_pack',
    helperIds: [
      'windows-kilo-native-installer',
      'linux-kilo-native-installer',
      'macos-kilo-native-installer',
    ],
    currentHome: 'cats-platform/scripts/{windows,linux,macos}/Install-KiloCli.{ps1,sh}',
    targetHome: 'cats-platform packaged-host provider assets',
    notes: [
      'Bundled through the repo-owned per-CLI npm-global helper on each supported host platform.',
      'Distinct from Kiro CLI (separate native MSI helper).',
    ],
  },
  {
    id: 'auggie',
    ...
    pack: 'native_cli_pack',
    helperIds: [
      'windows-auggie-native-installer',
      'linux-auggie-native-installer',
      'macos-auggie-native-installer',
    ],
    currentHome: 'cats-platform/scripts/{windows,linux,macos}/Install-Auggie.{ps1,sh}',
    targetHome: 'cats-platform packaged-host provider assets',
    notes: [
      'Bundled through the repo-owned per-CLI npm-global helper on each supported host platform.',
    ],
  },
  {
    ...
    pack: 'native_cli_pack',
    helperIds: [
      'windows-pi-native-installer',
      'linux-pi-native-installer',
      'macos-pi-native-installer',
    ],
    currentHome: 'cats-platform/scripts/{windows,linux,macos}/Install-Pi.{ps1,sh}',
    targetHome: 'cats-platform packaged-host provider assets',
    notes: [
      'Bundled through the repo-owned per-CLI npm-global helper on each supported host platform.',
    ],
