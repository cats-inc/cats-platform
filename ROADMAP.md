...
- [ ] Replace the current stderr-only `originSurface` compatibility warning
      ...
      broader platform logging/reporting still remains.
...
- [ ] Add integration coverage for the warm-navigation seam instead of relying
      ...
      target-surface dispatch decisions, prefetch-surface resolution, targeted
      staged-handoff clear semantics, and staged draft handoff payloads; full
      mount/integration coverage still remains.
