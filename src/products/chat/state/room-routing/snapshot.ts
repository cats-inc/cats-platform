...
function normalizeRoomRoutingDispatch(rawDispatch: unknown): RoomRoutingDispatch | null {
  ...
  return {
    ...
    target,
    laneId: readNullableString(dispatchRecord.laneId),
    sessionId: readNullableString(dispatchRecord.sessionId),
...
function normalizeRoomWorkflowTarget(rawTarget: unknown): RoomWorkflowTargetState | null {
  ...
  return {
    ...
    participant,
    laneId: readNullableString(targetRecord.laneId),
    sessionId: readNullableString(targetRecord.sessionId),
    source: normalizeRoomRoutingParticipant(targetRecord.source),
    sourceMessageId: readString(targetRecord.sourceMessageId),
    sourceTurnId: readNullableString(targetRecord.sourceTurnId),
    sourceLaneId: readNullableString(targetRecord.sourceLaneId),
    sourceAssistantTurnId: readNullableString(targetRecord.sourceAssistantTurnId),
