...
export interface CatsRegistryActionsHookResult<TBotForm>
  extends CatsRegistryController<TBotForm> {
...
export interface CatsRegistryComponentProps<TBotForm> {
  ...
  registryController: CatsRegistryController<TBotForm>;
...
export interface CatsCanvasProps {
  payload: AppShellPayload;
  busy: WorkspaceBusyState;
  onPayloadUpdate: (payload: AppShellPayload) => void;
...
export interface SharedCatsCanvasProps extends CatsCanvasProps {
  useSettingsCatsRegistryActionsHook: (options: {
    ...
    onPayloadUpdate: (payload: AppShellPayload) => void;
    confirm?: (options: { title: string; message: string; confirmLabel?: string }) => Promise<boolean>;
  }) => CatsRegistryActionsHookResult<BotFormState>;
  CatsRegistryComponent?: ComponentType<CatsRegistryComponentProps<BotFormState>>;
}

export function CatsCanvas({
  payload,
  busy,
  onPayloadUpdate,
  onFeedback,
...
export interface WorkspaceCatsCanvasProps extends Omit<
  SharedCatsCanvasProps,
  'useSettingsCatsRegistryActionsHook' | 'CatsRegistryComponent'
> {}

export function WorkspaceCatsCanvas(props: WorkspaceCatsCanvasProps) {
  return (
    <CatsCanvas
      {...props}
      useSettingsCatsRegistryActionsHook={useSettingsCatsRegistryActions}
      CatsRegistryComponent={CatsRegistry}
    />
  );
}
