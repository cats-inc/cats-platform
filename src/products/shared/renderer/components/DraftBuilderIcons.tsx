  ...
  return (
    ...
    >
      {/* Chat bubble with a small tail at the bottom-left corner.
        ...
        * two teaching buttons feel equally weighted. Restored from
        * the pre-carousel design (commit 1ef2f8e4d, owner directive
        * 2026-05-01) — the plain plus that replaced it didn't read
        * as a "compare / add another conversation" affordance. */}
