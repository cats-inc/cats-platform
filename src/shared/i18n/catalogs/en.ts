...
export const enCatalog: MessageCatalog = {
  ...
  'lobbySidebar.mainPage': 'Back to Lobby',
  'lobby.entityColumnHeader.cats': 'Cats',
  'lobby.entityColumnHeader.clowders': 'Clowders',
  'lobby.entityColumnHeader.catteries': 'Catteries',
  'lobby.entityCard.total': '{count} total',
  'lobby.entityCard.openCanvasAriaLabel': 'Open {label}',
