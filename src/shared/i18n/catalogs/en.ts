...
export const enCatalog: MessageCatalog = {
  ...
  'work.item.external.empty': 'No external tracker links yet.',
  'work.item.external.linkAction': 'Link issue',
  'work.item.external.dialogTitle': 'Link external tracker',
  'work.item.external.closeLabel': 'Close external tracker dialog',
  'work.item.external.providerLabel': 'Provider',
  'work.item.external.typeLabel': 'Type',
  'work.item.external.type.issue': 'Issue',
  'work.item.external.type.ticket': 'Ticket',
  'work.item.external.type.project': 'Project',
  'work.item.external.idLabel': 'External ID',
  'work.item.external.idPlaceholder': '123 or BUG-42',
  'work.item.external.urlLabel': 'URL',
  'work.item.external.urlPlaceholder': 'https://github.com/org/repo/issues/123',
  'work.item.external.syncDirectionLabel': 'Sync intent',
  'work.item.external.sync.pull': 'Pull only',
  'work.item.external.sync.push': 'Push later',
  'work.item.external.sync.bidirectional': 'Bidirectional later',
  'work.item.external.cancelButton': 'Cancel',
  'work.item.external.submitLabel': 'Link tracker',
  'work.item.external.submitBusyLabel': 'Linking…',
  'work.item.external.linkError': 'Failed to link external tracker.',
