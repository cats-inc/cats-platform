...
| [terminology.md](./terminology.md) | Complete | Product and protocol terms, including `Boss Cat`, `Boss Chat`, `Direct Cat Chat`, sleep/wake lifecycle, transport inboxes, `Cats Core v1`, bot bindings, approvals, and owner profile |
| [a2a/](./a2a/) | Template | A2A agent card and task templates, not yet customized for `cats-inc` |
| [specs/](./specs/) | Complete | Feature specifications, including suite-foundation work, primary-orchestrator/setup-wizard behavior, provider and transport seams, the new chat sleep/wake lifecycle, Telegram inbox-to-room routing, and direct-Cat routing behavior |
...
| [decisions/](./decisions/) | Complete | Architecture Decision Records, including runtime-boundary refinements, the visible primary-orchestrator model, frozen parallel-delivery ownership boundaries, the accepted chat sleep/wake lifecycle direction, the Telegram inbox transport model, and the direct-Cat routing model |
