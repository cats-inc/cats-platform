...
| [specs/](./specs/) | Complete | Feature specifications, including suite-foundation work, chat-first information architecture with a default Boss Cat, primary-orchestrator/setup-wizard behavior, packaged setup/provider-installation direction, chat delivery-policy/governance levels, budget policy and war-room cost-control direction, provider and transport seams, the new chat sleep/wake lifecycle, Telegram inbox-to-room routing, direct-Cat routing behavior, dynamic explicit-mention plus room-workflow orchestration, skill profile/runtime skill-manifest ownership, embedded preview surfaces, and contextual MCP/lazy tool activation |
| [plans/](./plans/) | Complete | Implementation plans, including suite-foundation work, self-hosted npm app packaging, chat-first Add-cat and setup-wizard refinement, parallel-workstream seams, the chat sleep/wake lifecycle plan, and the first dynamic room-workflow orchestration plan |
