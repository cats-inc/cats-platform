...
|-----|-------|--------|------|
| [ADR-119](119-share-product-knowledge-and-role-procedures-with-supervised-agents.md) | Share Product Knowledge and Role Procedures with Supervised Agents | Accepted; K1 knowledge wired, collaboration operations pending | 2026-09-24 |
