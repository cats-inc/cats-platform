...
|-----|-------|--------|------|
| [ADR-119](119-share-product-knowledge-and-role-procedures-with-supervised-agents.md) | Share Product Knowledge and Role Procedures with Supervised Agents | Accepted; K1 knowledge and K2 read/preparation wired; mutations/live acceptance pending | 2026-09-24 |
