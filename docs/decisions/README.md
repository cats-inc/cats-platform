...
| [068-own-chat-continuity-semantics-above-runtime-session-boundaries](./068-own-chat-continuity-semantics-above-runtime-session-boundaries.md) | Own chat continuity semantics above runtime-session boundaries | Proposed | 2026-04-17 |
