...
| [091-retire-composer-mode-cat-led-in-favor-of-recipient-state](./091-retire-composer-mode-cat-led-in-favor-of-recipient-state.md) | Retire `composerMode = cat_led` in favor of channel intent | Accepted | 2026-04-29 |
