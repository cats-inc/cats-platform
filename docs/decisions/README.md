...
|-----|-------|--------|------|
| [ADR-119](119-share-product-knowledge-and-role-procedures-with-supervised-agents.md) | Share Product Knowledge and Role Procedures with Supervised Agents | Accepted; K1-K3 CI-validated; K4 distribution/native startup verified; full live execution pending | 2026-09-25 |
