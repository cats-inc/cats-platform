...
| [111-keep-first-admin-local-and-require-step-up-for-google-linking](./111-keep-first-admin-local-and-require-step-up-for-google-linking.md) | Keep First-Admin Bootstrap Local and Require Step-Up for Google Linking | Proposed | 2026-09-01 |
...
*Last updated: 2026-09-01 (ADR-111 local first-Admin and step-up-protected Google linking proposed.)*
