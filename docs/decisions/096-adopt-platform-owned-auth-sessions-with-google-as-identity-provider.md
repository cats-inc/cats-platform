...
*Amended: 2026-09-02 — accepted ADR-111/SPEC-113 now requires mandatory local first-Admin bootstrap, a promotion-period 8-to-256-Unicode-code-point password policy without composition rules, step-up-protected Google link/unlink, and revocation of other Sessions on unlink.*
