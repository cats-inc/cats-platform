...
|------|-------|--------|--------------|
| [SPEC-118](SPEC-118-orchestrator-knowledge-and-collaboration-operations.md) | Orchestrator Knowledge and Collaboration Operations | In progress; bounded live K3/native projections and K2 context reuse CI pass; native K2/profile gates open | [PLAN-110](../plans/PLAN-110-orchestrator-knowledge-and-collaboration-rollout.md), [ADR-119](../decisions/119-share-product-knowledge-and-role-procedures-with-supervised-agents.md) |
