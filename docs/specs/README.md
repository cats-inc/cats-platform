...
|------|-------|--------|--------------|
| [SPEC-112](./SPEC-112-grok-devin-cline-aider-in-packaged-setup-and-provider-catalog.md) | Grok, Devin, Cline, and Aider in Packaged Setup and the Setup Provider Inventory | In Progress — Grok slice implemented | [PLAN-102](../plans/PLAN-102-grok-devin-cline-aider-packaged-setup-rollout.md), [ADR-109](../decisions/109-port-grok-devin-cline-aider-installers-into-packaged-setup.md) |
...
*Last updated: 2026-08-08 (SPEC-112 Grok slice implemented; remaining providers stay approval-gated.)*
