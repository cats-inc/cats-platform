...
|------|-------|--------|--------------|
| [SPEC-117](SPEC-117-cats-self-development-and-catlas-practice.md) | Cats Self-Development and Catlas Practice | Draft; two-profile distribution and knowledge-fed inference specified, implementation pending | [PLAN-109](../plans/PLAN-109-cats-self-development-and-catlas-practice.md), [ADR-118](../decisions/118-use-isolated-development-and-verified-practice-for-cats-improvement.md) |
