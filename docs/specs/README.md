...
| [SPEC-076](./SPEC-076-per-entity-state-subscription-protocol.md) | Per-Entity State Subscription Protocol | Partially Implemented | [PLAN-068](../plans/PLAN-068-per-entity-state-subscription-rollout.md), [PLAN-098](../plans/PLAN-098-polymorphic-entity-subscription-follow-up.md), [ADR-075](../decisions/075-adopt-push-based-per-entity-state-subscription.md) |
