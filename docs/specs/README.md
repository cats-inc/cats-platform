...
|------|-------|--------|--------------|
| [SPEC-070](./SPEC-070-product-scoped-recents-and-channel-origin-surfaces.md) | Product-Scoped Recents and Channel Origin Surfaces | Draft | [PLAN-060](../plans/PLAN-060-product-scoped-recents-and-origin-surface-rollout.md), [ADR-069](../decisions/069-scope-recents-to-channel-origin-surface-by-default.md) |
