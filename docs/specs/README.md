...
|------|-------|--------|--------------|
| [SPEC-105](./SPEC-105-direct-chat-implicit-product-intent.md) | Direct Chat Implicit Product Intent Confirmation | Draft | [PLAN-093](../plans/PLAN-093-direct-chat-implicit-product-intent-rollout.md), [ADR-101](../decisions/101-use-direct-audience-cat-for-slash-mode-work-intake.md) |
