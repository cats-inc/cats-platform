...
|------|-------|--------|--------------|
| [SPEC-118](SPEC-118-orchestrator-knowledge-and-collaboration-operations.md) | Orchestrator Knowledge and Collaboration Operations | In progress; K1-K2 implemented and CI-validated; K3-K4 pending | [PLAN-110](../plans/PLAN-110-orchestrator-knowledge-and-collaboration-rollout.md), [ADR-119](../decisions/119-share-product-knowledge-and-role-procedures-with-supervised-agents.md) |
