...
reserved for direct-lane participant stacks. The same slice also requires those
controls to persist into created-channel runtime defaults so the draft header
is not just decorative chrome.
