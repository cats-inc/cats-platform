...
- [SPEC-113: Admin Bootstrap and Google Account Linking](./SPEC-113-admin-bootstrap-and-google-account-linking.md) — proposed focused follow-up for mandatory local first-Admin bootstrap and step-up-protected Google link/unlink
...
*Created: 2026-04-30*
*Last updated: 2026-09-01 — linked proposed SPEC-113 identity-lifecycle follow-up.*
*Author: Codex*
