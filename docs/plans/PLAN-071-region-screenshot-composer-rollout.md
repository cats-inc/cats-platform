...
| 2026-04-22 | Added macOS Screen Recording preflight: Electron now maps denied/restricted/not-determined `screen` media access to the screenshot contract's `permission_denied` outcome before opening overlays. |
