...
| `src/products/chat/renderer/components/ModelSelector.tsx` | Refactor | Let implicit-recipient rendering fit the new composer-recipient surface rather than acting like a separate solo-mode control |
