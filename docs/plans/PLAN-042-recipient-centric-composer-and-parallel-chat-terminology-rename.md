...
| `src/products/chat/renderer/components/ExecutionTarget.tsx` | Refactor | Let implicit-recipient rendering fit the new composer-recipient surface rather than acting like a separate solo-mode control |
