...
|------|-------|--------|--------------|
| [PLAN-098](./PLAN-098-polymorphic-entity-subscription-follow-up.md) | Polymorphic Entity Subscription Follow-up | Draft | [SPEC-076](../specs/SPEC-076-per-entity-state-subscription-protocol.md), [ADR-075](../decisions/075-adopt-push-based-per-entity-state-subscription.md), [PLAN-068](./PLAN-068-per-entity-state-subscription-rollout.md) |
...
| [PLAN-068](./PLAN-068-per-entity-state-subscription-rollout.md) | Per-Entity State Subscription Rollout | Channel slice implemented; follow-up in PLAN-098 | [SPEC-076](../specs/SPEC-076-per-entity-state-subscription-protocol.md), [ADR-075](../decisions/075-adopt-push-based-per-entity-state-subscription.md), [ADR-041](../decisions/041-push-transport-and-chat-invalidations-over-sse.md) |
