...
|------|-------|--------|--------------|
| [PLAN-093](./PLAN-093-direct-chat-implicit-product-intent-rollout.md) | Direct Chat Implicit Product Intent Rollout | Draft | [SPEC-105](../specs/SPEC-105-direct-chat-implicit-product-intent.md), [ADR-101](../decisions/101-use-direct-audience-cat-for-slash-mode-work-intake.md) |
