...
| [PLAN-109](PLAN-109-cats-self-development-and-catlas-practice.md) | Cats Self-Development and Catlas Practice | Managed candidate authoring fixtures pass; native ownership preflight passes, external inference authorization pending; combined gate open | [SPEC-117](../specs/SPEC-117-cats-self-development-and-catlas-practice.md), [ADR-118](../decisions/118-use-isolated-development-and-verified-practice-for-cats-improvement.md) |
