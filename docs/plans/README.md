...
|------|-------|--------|--------------|
| [PLAN-098](./PLAN-098-polymorphic-entity-subscription-follow-up.md) | Polymorphic Entity Subscription Follow-up | In Progress | [SPEC-076](../specs/SPEC-076-per-entity-state-subscription-protocol.md), [ADR-075](../decisions/075-adopt-push-based-per-entity-state-subscription.md), [PLAN-068](./PLAN-068-per-entity-state-subscription-rollout.md) |
...
| [PLAN-092](./PLAN-092-direct-chat-slash-mode-work-intake-rollout.md) | Direct Chat Slash-Mode Work Intake Rollout | Draft | [SPEC-104](../specs/SPEC-104-direct-chat-slash-mode-work-intake.md), [ADR-101](../decisions/101-use-direct-audience-cat-for-slash-mode-work-intake.md) |
