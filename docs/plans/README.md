...
|------|-------|--------|--------------|
| [PLAN-106](./PLAN-106-official-app-package-hosting.md) | Official App Package Hosting | Planned — architecture recorded; host implementation pending | [SPEC-115](../specs/SPEC-115-versioned-official-app-packages-and-telemetry-bridge.md), [ADR-114](../decisions/114-separate-official-app-sources-and-coordinate-desktop-distribution.md) |
