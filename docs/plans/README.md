...
|------|-------|--------|--------------|
| [PLAN-110](PLAN-110-orchestrator-knowledge-and-collaboration-rollout.md) | Orchestrator Knowledge and Collaboration Rollout | In progress; K1 validated; K2 read/preparation fixtures pass; K3-K4 pending | [SPEC-118](../specs/SPEC-118-orchestrator-knowledge-and-collaboration-operations.md), [ADR-119](../decisions/119-share-product-knowledge-and-role-procedures-with-supervised-agents.md) |
