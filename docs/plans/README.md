...
|------|-------|--------|--------------|
| [PLAN-074](./PLAN-074-cats-work-agent-supervision-rollout.md) | Cats Work Agent Supervision Rollout | In Progress | [SPEC-082](../specs/SPEC-082-cats-work-agent-supervision-and-tool-boundary.md), [ADR-082](../decisions/082-recast-orchestrator-as-capability-shell-with-policy-dial-supervision.md) |
