...
| [PLAN-077](./PLAN-077-companion-profile-and-share-preview-rollout.md) | Companion Profile and Share Preview Rollout | Active — Phase 1 complete behind flag, Phase 2–5 logic landed pending renderer wiring | [SPEC-085](../specs/SPEC-085-companion-profile-feed-and-library-ia.md), [SPEC-086](../specs/SPEC-086-shareable-companion-content-links-and-chat-previews.md), [ADR-084](../decisions/084-adopt-companion-profile-ia-and-shareable-content-references.md) |
...
*Last updated: 2026-04-28 (PLAN-079 added for Work Graph link relations; PLAN-078 marked Cancelled alongside ADR-085 rejection.)*
