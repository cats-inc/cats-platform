...
|------|-------|--------|--------------|
| [PLAN-110](PLAN-110-orchestrator-knowledge-and-collaboration-rollout.md) | Orchestrator Knowledge and Collaboration Rollout | In progress; bounded live K3/native projections and K2 context/accounting CI pass; native K2/profile gates open | [SPEC-118](../specs/SPEC-118-orchestrator-knowledge-and-collaboration-operations.md), [ADR-119](../decisions/119-share-product-knowledge-and-role-procedures-with-supervised-agents.md) |
| [PLAN-109](PLAN-109-cats-self-development-and-catlas-practice.md) | Cats Self-Development and Catlas Practice | In progress; initial Code help implemented, combined preview-to-release gate pending | [SPEC-117](../specs/SPEC-117-cats-self-development-and-catlas-practice.md), [ADR-118](../decisions/118-use-isolated-development-and-verified-practice-for-cats-improvement.md) |
...
| [PLAN-102](./PLAN-102-grok-devin-cline-aider-packaged-setup-rollout.md) | Grok, Devin, Cline, and Aider Packaged Setup Rollout | In Progress — all four ported; Grok, Cline, and Devin executable; Aider retired by [ADR-113](../decisions/113-port-the-meta-muse-installer-into-packaged-setup-and-retire-aider.md); packaged smoke deferred to PLAN-103 | [SPEC-112](../specs/SPEC-112-grok-devin-cline-aider-in-packaged-setup-and-provider-catalog.md), [ADR-109](../decisions/109-port-grok-devin-cline-aider-installers-into-packaged-setup.md) |
...
| [PLAN-092](./PLAN-092-direct-chat-slash-mode-work-intake-rollout.md) | Direct Chat Slash-Mode Work Intake Rollout | Implemented | [SPEC-104](../specs/SPEC-104-direct-chat-slash-mode-work-intake.md), [ADR-101](../decisions/101-use-direct-audience-cat-for-slash-mode-work-intake.md) |
| [PLAN-091](./PLAN-091-lobby-sidebar-and-entity-routes-rollout.md) | Lobby Sidebar and Entity Routes Rollout | In Progress (Phase 7–14 IA correction landed; Clowder/Cattery deferred) | [SPEC-102](../specs/SPEC-102-lobby-sidebar-ia-and-entity-routes.md), [SPEC-103](../specs/SPEC-103-clowder-and-cattery-data-model.md), [ADR-099](../decisions/099-promote-cats-clowders-catteries-to-platform-entities.md), [ADR-100](../decisions/100-cats-as-canonical-identity-with-clowder-and-cattery-as-associations.md) |
...
| [PLAN-086 Raw String Audit](./PLAN-086-ui-localization-raw-string-audit.md) | UI Localization Raw-String Audit | Active allowlist | [SPEC-097](../specs/SPEC-097-platform-language-settings-and-ui-localization.md), [PLAN-086](./PLAN-086-platform-language-settings-and-ui-localization-rollout.md) |
...
| [PLAN-077](./PLAN-077-companion-profile-and-share-preview-rollout.md) | Companion Profile and Share Preview Rollout | Implementation complete (new IA is the only IA, no flag) | [SPEC-085](../specs/SPEC-085-companion-profile-feed-and-library-ia.md), [SPEC-086](../specs/SPEC-086-shareable-companion-content-links-and-chat-previews.md), [ADR-084](../decisions/084-adopt-companion-profile-ia-and-shareable-content-references.md) |
...
| [PLAN-068](./PLAN-068-per-entity-state-subscription-rollout.md) | Per-Entity State Subscription Rollout | Partially Implemented | [SPEC-076](../specs/SPEC-076-per-entity-state-subscription-protocol.md), [ADR-075](../decisions/075-adopt-push-based-per-entity-state-subscription.md), [ADR-041](../decisions/041-push-transport-and-chat-invalidations-over-sse.md) |
| [PLAN-067](./PLAN-067-platform-browser-ingress-rollout.md) | Platform Browser Ingress Rollout | Mostly Implemented (Phase 1A/1B/2 landed; second-device + tunnel diagnostics operator-gated) | [SPEC-075](../specs/SPEC-075-platform-browser-ingress-for-lan-and-tunneled-access.md), [ADR-074](../decisions/074-keep-browser-ingress-at-platform-host-and-phase-lan-before-tunnels.md) |
...
*Last updated: 2026-09-24 (PLAN-109 records initial Code knowledge assistance and pending live/native acceptance.)*
