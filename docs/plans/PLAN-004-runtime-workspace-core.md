...
1. Expand the shared workspace contract to cover channels, members, sessions, messages, and export.
...
4. Extend the renderer with channel setup, member management, transcript, and orchestrator surfaces.
