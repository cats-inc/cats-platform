...
| 2026-09-02 | PLAN-104 was approved as the focused follow-up for mandatory local first-Admin bootstrap, a promotion-period non-empty/no-composition password policy, server-bound step-up, Settings Google link/unlink, and other-Session revocation on unlink. No PLAN-104 implementation has started. |
