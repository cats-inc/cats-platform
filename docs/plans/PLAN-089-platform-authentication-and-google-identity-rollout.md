...
- [x] Task 2.2: Implement synchronizer CSRF validation for mutating
...
- [x] Task 5.1: Add `auth` / `principal` to shared route contexts without
...
| 2026-09-02 | PLAN-104 was approved as the focused follow-up for mandatory local first-Admin bootstrap, a promotion-period 8-to-256-Unicode-code-point password policy without composition rules, server-bound step-up, Settings Google link/unlink, and other-Session revocation on unlink. No PLAN-104 implementation has started. |
