...
- `cats-inc/docs/specs/SPEC-014-telegram-boss-cat-relay-mvp.md`
- `cats-inc/docs/specs/SPEC-017-telegram-inbox-and-room-routing.md`
- `cats-inc/docs/specs/SPEC-018-direct-cat-chat-and-conversation-routing-layer.md`
- `cats-inc/docs/specs/SPEC-019-product-skill-profiles-and-runtime-skill-manifests.md`
- `cats-inc/docs/specs/SPEC-022-cats-memory-layering-and-ownership.md`
...
- `cats-inc/docs/research/2026-03-19-openclaw-memory-layering-benchmark.md`
