...
| [paperclip-control-plane-analysis](./paperclip-control-plane-analysis.md) | 2026-03-16 | Paperclip concepts and feature map | Unreviewed local analysis of Paperclip's control-plane model and rewrite takeaways for `cats-inc` |
